  ...
  <div>
    <section class="body-font">
      <div class="container mx-auto flex py-24 items-center justify-center flex-col">
        ...
        <div class="relative">
          <!-- Your Image -->
          <NuxtImg class="object-cover object-center" alt="hero" src="/zapisatsa.jpg" />
          ...
          <div class="absolute inset-0 flex flex-col space-y-6 sm:space-y-10 items-center justify-center">
            ...
            <UButton class="text-xl sm:text-2xl bg-gradient-to-r from-indigo-500 to-red-500 opacity-75 hover:opacity-100" label="Записаться" />
          </div>
        </div>
      </div>
    </section>
